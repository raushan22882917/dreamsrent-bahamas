...
export default function RentalGridPage() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-2 text-xs font-semibold text-gray-400 mb-2">
            ...
            <span>/</span>
            <span className="text-orange-600">Grid View</span>
          </div>
          <h1 className="text-3xl sm:text-4xl font-black text-gray-900">
            Available Rental Vehicles
          </h1>
          <p className="text-sm text-gray-500 mt-1">
            Choose from 20 high-performance convertibles, luxury sedans, and 7-passenger island SUVs.
          </p>
        </div>
